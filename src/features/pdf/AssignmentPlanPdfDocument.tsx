...
function DayCard({ day, pdfMode }: { day: AssignmentDay; pdfMode: PdfMode }) {
  ...
  return (
    <View style={day.isRestDay ? [styles.dayCard, styles.restDayCard] : styles.dayCard} wrap={false}>
      <View style={styles.dayHeader}>
        <Text style={styles.dayTitle}>
          {day.date}（{day.dayOfWeek}）
        </Text>
        <Text style={day.isRestDay ? [styles.badge, styles.restBadge] : styles.badge}>
